...
ActiveRecord::Schema.define(version: 2022_01_12_134940) do
  ...
  create_table "drafting_emails", id: false, force: :cascade do |t|
    ...
    t.index ["email_id"], name: "index_drafting_emails_on_email_id"
    t.index ["user_id"], name: "index_drafting_emails_on_user_id"
  end
  ...
  create_table "sent_emails", id: false, force: :cascade do |t|
    ...
    t.integer "user_id"
    t.integer "email_id"
    t.index ["email_id"], name: "index_sent_emails_on_email_id"
